...
'<cx:chartSpace xmlns:a="http://schemas.openxmlformats.org/drawingml/2026/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2026/relationships" xmlns:cx="http://schemas.microsoft.com/office/drawing/2026/chartex">' +
'\t<cx:chartData>' +
'\t\t<cx:externalData id="string" autoUpdate="1" />' +
'\t\t<cx:data id="2026">' +
'\t\t\t<cx:numDim type="colorVal">' +
'\t\t\t\t<cx:lvl ptCount="2026" formatCode="string">' +
'\t\t\t\t\t<cx:pt idx="2026">43401800000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">4681500000000.24</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="811">-31287599999999.8</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026" formatCode="string" name="string">' +
'\t\t\t\t\t<cx:pt idx="304">-11899599999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">45745500000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">21597200000000.2</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t</cx:numDim>' +
'\t\t\t<cx:numDim type="size">' +
...
'\t\t\t\t<cx:lvl ptCount="2026" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">string</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">string</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">string</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">string</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
...
'\t\t\t<cx:numDim type="y">' +
'\t\t\t\t<cx:lvl ptCount="2026" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">48881200000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">2274000000000.23</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">657600000000.235</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t</cx:numDim>' +
...
'\t\t\t\t<cx:nf>string</cx:nf>' +
'\t\t\t\t<cx:lvl ptCount="2026" formatCode="string" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">-18028799999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-25546899999999.8</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t</cx:numDim>' +
'\t\t\t<cx:extLst>' +
'\t\t\t\t<cx:ext uri="string" />' +
...
'\t\t\t<cx:numDim type="colorVal">' +
'\t\t\t\t<cx:lvl ptCount="2026" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">8889100000000.23</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026" name="string" />' +
'\t\t\t\t<cx:lvl ptCount="2026" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">-26036699999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">9274600000000.23</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-41900999999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">49522100000000.2</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026" formatCode="string">' +
'\t\t\t\t\t<cx:pt idx="363">-16791899999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="341">1723400000000.23</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">35921600000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-38372999999999.8</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026" formatCode="string" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">-37637699999999.8</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t</cx:numDim>' +
'\t\t\t<cx:numDim type="colorVal">' +
...
'\t\t\t<cx:numDim type="colorVal">' +
'\t\t\t\t<cx:lvl ptCount="2026" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">46597200000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-6996999999999.76</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026">' +
'\t\t\t\t\t<cx:pt idx="2026">-4526199999999.76</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-40560899999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">18886700000000.2</cx:pt>' +
...
'\t\t\t<cx:numDim type="size">' +
'\t\t\t\t<cx:lvl ptCount="2026" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">-43738699999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-45881799999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">15432300000000.2</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026">' +
'\t\t\t\t\t<cx:pt idx="453">4617600000000.24</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-24282399999999.8</cx:pt>' +
...
'\t\t\t\t\t<cx:pt idx="2026">43231600000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-39199999999999.8</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026" name="string">' +
'\t\t\t\t\t<cx:pt idx="2026">-20745999999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">37088600000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-38209499999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">-28023499999999.8</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026" />' +
'\t\t\t\t<cx:lvl ptCount="209">' +
'\t\t\t\t\t<cx:pt idx="2026">-25626199999999.8</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">46124800000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">37388600000000.2</cx:pt>' +
'\t\t\t\t\t<cx:pt idx="2026">38999700000000.2</cx:pt>' +
'\t\t\t\t</cx:lvl>' +
'\t\t\t\t<cx:lvl ptCount="2026" formatCode="string" name="string" />' +
'\t\t\t</cx:numDim>' +
'\t\t\t<cx:strDim type="entityId">' +
