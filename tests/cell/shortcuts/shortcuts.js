...
(function (window)
{
	...
	QUnit.test('Test catch events', (assert) =>
	{
		...
		hyperlink.Hyperlink = "https://www.univaultoffice.com/";
		...
		ExecuteTestWithCatchEvent('asc_onHyperlinkClick', (sValue) => sValue, 'https://www.univaultoffice.com/', graphicEvents[graphicHotkeyTypes.visitHyperink][0]);
