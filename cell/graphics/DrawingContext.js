...
(function (/** Window */window, undefined) {
	...
	function DrawingContext(settings) {
		...
		// Font должен быть передан (он общий для всех DrawingContext, т.к. может возникнуть ситуация как в баге http://bugzilla.univaultoffice.com/show_bug.cgi?id=19784)
		if (null === this.font) {
