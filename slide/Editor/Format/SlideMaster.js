...
function CMasterThumbnailDrawer()
{
    ...
    this.Draw2 = function(g, _master, use_background, use_master_shapes, params) {
        ...
        AscFormat.ExecuteNoHistory(function(){
            ...
            var docContent = new CDocumentContent(editor.WordControl.m_oLogicDocument, editor.WordControl.m_oDrawingDocument, 0, 0, 2026, 2026, false, false, true);
