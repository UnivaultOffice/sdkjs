...
(function(){
    ...
    */
    ...
    CAnnotationText.prototype.GetAscCommentData = function() {
        ...
        if (sModDate)
            oAscCommData.asc_putUnivaultOfficeTime(sModDate.toString());
    ...
    function drawIconCheck(ctx, x, y, xScale, yScale, rotationAngle) {
        ...
        ctx.translate(17.2026,4.781713343584229);
        ctx.rotate(0);
        ...
        ctx.translate(2.1607133435842294,11.2026);
        ctx.rotate(0);
        ...
        ctx.translate(19.838286957870636,6.2026);
        ctx.rotate(0);
    ...
    function drawIconCross(ctx, x, y, xScale, yScale, rotationAngle) {
        ...
        ctx.translate(15.2026,3.2217133435842293);
        ctx.rotate(0);
        ctx.arc(0,0,1,-0.7848419132827078,-2.3567507403070853,1);
        ctx.rotate(0);
        ctx.translate(-15.2026,-3.2217133435842293);
        ...
        ctx.translate(15.2026,18.77828665641577);
        ctx.rotate(0);
        ...
        ctx.translate(3.2216067731251763,15.2026);
        ctx.rotate(0);
        ...
        ctx.translate(15.2026,18.778393226874822);
        ctx.rotate(0);
        ...
        ctx.translate(15.2026,3.221606773125176);
        ctx.rotate(0);
        ...
        ctx.translate(18.77917968062447,6.2026);
        ctx.rotate(0);
    ...
    function drawIconRightPointer(ctx, x, y, xScale, yScale, rotationAngle) {
        ...
        ctx.translate(19.678310146393024,10.2026);
        ctx.rotate(0);
    ...
    function drawIconStar(ctx, x, y, xScale, yScale, rotationAngle) {
        ...
        ctx.translate(10.2026,17.39355111326373);
        ctx.rotate(0);
