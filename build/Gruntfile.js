...
module.exports = function(grunt) {
	...
	const appCopyright = process.env['APP_COPYRIGHT'] || "Copyright (C) UNIVAULT TECHNOLOGIES 2012-" + grunt.template.today('yyyy') +". All rights reserved";
	const publisherUrl = process.env['PUBLISHER_URL'] || "https://www.univaultoffice.com/";
