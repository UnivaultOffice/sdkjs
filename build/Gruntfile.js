...
module.exports = function(grunt) {
	...
	const appCopyright = process.env['APP_COPYRIGHT'] || "Copyright (C) Univault Technologies 2026-" + grunt.template.today('yyyy') +". All rights reserved";
	const publisherUrl = process.env['PUBLISHER_URL'] || "https://www.univaultoffice.github.io/";
	const companyName = process.env['COMPANY_NAME'] || 'univaultoffice';
